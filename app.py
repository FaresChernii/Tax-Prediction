...
api_key = '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'
...
def index():
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('show_result', prediction=result, recommendation=recommendation))
